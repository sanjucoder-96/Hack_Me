async function audit(mount) {
  mount.innerHTML = `
    <div class="sec-hdr fade-up">
      <div><h2>Groq Audit Explainer</h2><p>Court-defensible narratives · Counterfactual remediation · 8-hop graph traversal</p></div>
    ...
    <div class="g2 fade-up-1">
      <div class="card" style="height:fit-content">
        ...
        <div style="font-size:10px;color:var(--muted);margin-bottom:12px">Click any invoice to generate full Groq AI audit trail with court-defensible evidence</div>
